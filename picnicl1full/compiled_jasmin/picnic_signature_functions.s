	...
	.globl	_jazz_mpc_substitution
	.globl	jazz_mpc_substitution
...
Ljazz_mpc_getBit_verify$1:
	...
	movb	%sil, 5(%rcx)
	ret 
_jazz_mpc_substitution:
jazz_mpc_substitution:
	movq	%rsp, %rax
	leaq	-32(%rsp), %rsp
	andq	$-8, %rsp
	movq	%rax, (%rsp)
	...
	imulq	$3, %rax, %rax
	movq	$0, %rcx
	jmp 	Ljazz_mpc_substitution$1
Ljazz_mpc_substitution$2:
	movq	%rcx, %rsi
	addq	$2, %rsi
	movq	%rsi, %rdx
	shrq	$3, %rdx
	...
	movq	$7, %r9
	subq	%r8, %r9
	jmp 	Ljazz_mpc_substitution$19
Ljazz_mpc_substitution$20:
	shrb	$1, %dl
	addq	$-1, %r9
Ljazz_mpc_substitution$19:
	cmpq	$0, %r9
	jnbe	Ljazz_mpc_substitution$20
	andb	$1, %dl
	movq	%rsi, %r8
	addq	$-1, %r8
	shrq	$3, %r8
	...
	movq	$7, %r10
	subq	%r9, %r10
	jmp 	Ljazz_mpc_substitution$17
Ljazz_mpc_substitution$18:
	shrb	$1, %r8b
	addq	$-1, %r10
Ljazz_mpc_substitution$17:
	cmpq	$0, %r10
	jnbe	Ljazz_mpc_substitution$18
	andb	$1, %r8b
	movq	%rsi, %r9
	addq	$-2, %r9
	shrq	$3, %r9
	...
	movq	$7, %r10
	subq	%rsi, %r10
	jmp 	Ljazz_mpc_substitution$15
Ljazz_mpc_substitution$16:
	shrb	$1, %r9b
	addq	$-1, %r10
Ljazz_mpc_substitution$15:
	cmpq	$0, %r10
	jnbe	Ljazz_mpc_substitution$16
	andb	$1, %r9b
	movq	%rcx, %r10
	addq	$2, %r10
	movb	%r8b, %sil
	...
	movq	%rbp, %rbx
	movb	$1, %r12b
	jmp 	Ljazz_mpc_substitution$13
Ljazz_mpc_substitution$14:
	shlb	$1, %r12b
	addq	$-1, %rbp
Ljazz_mpc_substitution$13:
	cmpq	$0, %rbp
	jnbe	Ljazz_mpc_substitution$14
	xorb	$-1, %r12b
	andb	%r12b, %r11b
	jmp 	Ljazz_mpc_substitution$11
Ljazz_mpc_substitution$12:
	shlb	$1, %r9b
	addq	$-1, %rbx
Ljazz_mpc_substitution$11:
	cmpq	$0, %rbx
	jnbe	Ljazz_mpc_substitution$12
	orb 	%r9b, %r11b
	movq	%r10, %r9
	shrq	$3, %r9
	movb	%r11b, (%rdi,%r9)
	...
	movq	%rbp, %rbx
	movb	$1, %r12b
	jmp 	Ljazz_mpc_substitution$9
Ljazz_mpc_substitution$10:
	shlb	$1, %r12b
	addq	$-1, %rbp
Ljazz_mpc_substitution$9:
	cmpq	$0, %rbp
	jnbe	Ljazz_mpc_substitution$10
	xorb	$-1, %r12b
	andb	%r12b, %r11b
	jmp 	Ljazz_mpc_substitution$7
Ljazz_mpc_substitution$8:
	shlb	$1, %r9b
	addq	$-1, %rbx
Ljazz_mpc_substitution$7:
	cmpq	$0, %rbx
	jnbe	Ljazz_mpc_substitution$8
	orb 	%r9b, %r11b
	movq	%r10, %r9
	shrq	$3, %r9
	movb	%r11b, (%rdi,%r9)
	...
	movq	%rsi, %r8
	movb	$1, %r11b
	jmp 	Ljazz_mpc_substitution$5
Ljazz_mpc_substitution$6:
	shlb	$1, %r11b
	addq	$-1, %rsi
Ljazz_mpc_substitution$5:
	cmpq	$0, %rsi
	jnbe	Ljazz_mpc_substitution$6
	xorb	$-1, %r11b
	andb	%r11b, %dl
	jmp 	Ljazz_mpc_substitution$3
Ljazz_mpc_substitution$4:
	shlb	$1, %r9b
	addq	$-1, %r8
Ljazz_mpc_substitution$3:
	cmpq	$0, %r8
	jnbe	Ljazz_mpc_substitution$4
	orb 	%r9b, %dl
	shrq	$3, %r10
	movb	%dl, (%rdi,%r10)
	addq	$3, %rcx
Ljazz_mpc_substitution$1:
	cmpq	%rax, %rcx
	jb  	Ljazz_mpc_substitution$2
	movq	8(%rsp), %rbx
	movq	16(%rsp), %rbp
	movq	24(%rsp), %r12
	movq	(%rsp), %rsp
