...
Lzkboo_decrypt$352:
	movl	(%rdx,%rbp), %r12d
	movl	%r12d, 3408(%rsp,%rbp,4)
	movl	(%rcx,%rbp), %r12d
	movl	%r12d, 1936(%rsp,%rbp,4)
	incq	%rbp
	incq	%rbx
Lzkboo_decrypt$351:
	cmpq	$368, %rbx
...
Lzkboo_decrypt$5:
	...
	movq	(%rsp), %rdx
	movl	3408(%rsp,%rdx,4), %ebp
	movl	%ebp, 1136(%rsp)
	movl	1936(%rsp,%rdx,4), %edx
	movl	%edx, 1140(%rsp)
	movl	1080(%rsp), %edx
	andl	1132(%rsp), %edx
	movl	1084(%rsp), %ebp
...
Lzkboo_decrypt$90:
	...
	orl 	%ebx, %r12d
	movl	%r12d, 1124(%rsp)
	movl	3408(%rsp,%r8,4), %ebp
	movl	%ebp, 1152(%rsp)
	movl	1936(%rsp,%r8,4), %r8d
	movl	%r8d, 1156(%rsp)
	imulq	$782, %rcx, %r8
	addq	32(%rsp), %r8
	movq	$0, %rbp
...
Lzkboo_decrypt$71:
	...
	movq	32(%rsp), %r8
	incq	%r8
	movl	3408(%rsp,%r9,4), %ebp
	movl	%ebp, 1152(%rsp)
	movl	1936(%rsp,%r9,4), %r9d
	movl	%r9d, 1156(%rsp)
	imulq	$782, %rcx, %r9
	addq	32(%rsp), %r9
	movq	$0, %rbp
...
Lzkboo_decrypt$33:
	...
	movq	32(%rsp), %r10
	incq	%r10
	movl	3408(%rsp,%r11,4), %edx
	movl	%edx, 1152(%rsp)
	movl	1936(%rsp,%r11,4), %edx
	movl	%edx, 1156(%rsp)
	imulq	$782, %rcx, %rdx
	addq	32(%rsp), %rdx
	movq	$0, %r11
